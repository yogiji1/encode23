   ...
   # try:
    #      user = await bot.get_chat_member(update_channel, update.chat.id)
     #     if user.status == "kicked":
      ...
      #             text="Sorry Sir, You are Banned to use me. Contact my [Boss](https://t.me/cmd_rulf).",
      #             parse_mode="markdown",
    ...
    #    except Exception:
     #       await bot.send_message(
      #          chat_id=update.chat.id,
       #         text="Something went Wrong. Contact my [Boss](https://t.me/cmd_rulf).",
        #        parse_mode="markdown",
         #       disable_web_page_preview=True)
          #  return
    await bot.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('🌐 UPDATES 🌐', url='https://t.me/Max_Leech_Zone_Update')
                ]
            ]
        ),
